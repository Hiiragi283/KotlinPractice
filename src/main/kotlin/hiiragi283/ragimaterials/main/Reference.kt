...
object Reference {
    //MOD IDの定義
    const val MOD_ID = "ragimaterials"
    ...
    //Client側のProxyの定義
    const val CLIENT_PROXY_CLASS = "hiiragi283.ragimaterials.main.proxy.ClientProxy"

    //Server側のProxyの定義
    const val SERVER_PROXY_CLASS = "hiiragi283.ragimaterials.main.proxy.ServerProxy"
